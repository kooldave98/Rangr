...
using App.WebAPI.Infrastructure.DependencyConfiguration;
using Ninject;
...
namespace App.WebAPI
{
    ...
    public class NinjectHttpResolver : IDependencyResolver, IDependencyScope
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            var configurator = new AppWebApiConfiguration();

            configurator.configure(kernel, StandardDependencyScopes.InRequestScope);
        }
    }
