...
namespace App.Library.WebAPI.MultipartDataMediaFormatter.Infrastructure
{
    public class FormData
    {
        ...
        public void Add(string name, RawFile value)
        {
        ...
        public bool TryGetValue(string name, out RawFile value)
        {
