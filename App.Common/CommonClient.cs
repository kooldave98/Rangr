...
//		}
//
//		public async Task Start(Action<SeenPost> handler)
//		{
//			try {
...
//		}
//
//		private async Task RunHubConnectionAPI (Action<SeenPost> handler)
//		{
...
//
//			hubProxy.On<SeenPost> ("appendPost", (post) => _context.Post (async delegate {
//				//Write to Log
//				_traceWriter.WriteLine ("------------------------------------Append Post--> UserId: {0}, UserName : {1}, PostText : {2}>", post.user_id, post.user_display_name, post.text);
//
//
//				handler(post);
//
...
//			querystringData.Add ("userID", _session.GetCurrentUser ().user_id.ToString ());
//			querystringData.Add ("geoLocation", geolocationString.geolocation_value);
//
