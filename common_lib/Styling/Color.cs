...
namespace common_lib
{
    public struct Color
    {
        ...
        #if __ANDROID__
        public AndroidApp.Graphics.Color ToAndroidColor()
        {
            return AndroidApp.Graphics.Color.Rgb((int)(255 * R), (int)(255 * G), (int)(255 * B));
        }

        public static implicit operator AndroidApp.Graphics.Color(Color color)
        {
