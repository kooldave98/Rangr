...
namespace rangr.droid
{
    public class LoginFragment : VMFragment<LoginViewModel>, TextView.IOnEditorActionListener
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            userMobile = view.FindViewById<EditText>(Resource.Id.userMobile);
            ...
            userMobile.SetOnEditorActionListener(this);
            password.SetOnEditorActionListener(this);

            userMobile.TextChanged += (sender, e) =>
            {
                    view_model.user_mobile_number = userMobile.Text;
            };
        ...
        {
            if (!string.IsNullOrEmpty(userMobile.Text))
            {
        ...
        public bool OnEditorAction(TextView v, ImeAction actionId, KeyEvent e)
        {
            ...
            if (actionId == ImeAction.Go)
            {
                ...
                else if (string.IsNullOrEmpty(userMobile.Text))
                {
                    userMobile.RequestFocus();
                }
                else
        ...
        private EditText password, userMobile;
